...
<head>
    ...
    <title> SoundWave - User Settings</title>
...
<body class="bg-gray-50 dark:bg-gray-900">
    ...
    <section class="p-8 text-center">
        ...
        <h1 class="text-5xl  font-extrabold dark:text-white position:center">Settings</h1>

        <hr class="h-px my-8 bg-gray-200 border-0 dark:bg-gray-700">


        <h1 class="mb-4 text-l font-extrabold text-gray-900 dark:text-white md:text-l lg:text-xl">
            Change
            <span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Nickname</span>
        </h1>

        <a href='change/nickname.php'>
        ...
        <h1 class="mb-4 text-l font-extrabold text-gray-900 dark:text-white md:text-l lg:text-xl">
            Change
            <span class="text-transparent bg-clip-text bg-gradient-to-r to-pink-500 from-purple-500">Profile Picture</span>
        </h1>

        <a href='change/pfp.php'>
        ...
        <h1 class="mb-4 text-l font-extrabold text-gray-900 dark:text-white md:text-l lg:text-xl">
            Change
            <span class="text-transparent bg-clip-text bg-gradient-to-r to-blue-500 from-purple-600">Password</span>
        </h1>
        ...
        <a href='change/date_of_birth.php'>
