...
<head>
    ...
    <title> SoundWave - Change Profile Picture</title>
...
<body class="bg-gray-50 dark:bg-gray-900">
    ...
    <section class="p-8 text-center">
        ...
        <h1 class="text-2xl font-extrabold dark:text-white text-center">
            Your current profile picture is
        </h1>
        ...
        <form action="pfp2.php" method="post" enctype="multipart/form-data" class="max-w-sm mx-auto">
            ...
            <div class="flex items-start mb-5">
                ...
                <label for="terms" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                    I confirm that I want to change my profile picture
                </label>
            </div>
