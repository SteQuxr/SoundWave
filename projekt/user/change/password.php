...
<head>
    ...
    <title> SoundWave - Change password</title>
...
<body class="bg-gray-50 dark:bg-gray-900">
    ...
    <section class="p-8 text-center">
        ...
        <form action="password2.php" method="post" class="max-w-sm mx-auto">
            <div>
                <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">password</label>
                <input type="password" name="password" id="password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="••••••••" minlength="8" required="">
            </div>
            <div>
            ...
            <div class="flex items-start mb-5">
                ...
                <label for="terms" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">I confirm that i want to change my password</label>
            </div>
