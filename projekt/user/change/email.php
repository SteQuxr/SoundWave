...
<head>
    ...
    <title> SoundWave - Change Email</title>
...
<body class="bg-gray-50 dark:bg-gray-900">
    ...
    <section class="p-8 text-center">
        ...
        <h1 class="text-5xl  font-extrabold dark:text-white position:center">Change
            <span class="text-transparent bg-clip-text bg-gradient-to-r to-blue-500 from-cyan-500">Email</span>
        </h1>

        <hr class="h-px my-8 bg-gray-200 border-0 dark:bg-gray-700">

        <h1 class="text-2xl  font-extrabold dark:text-white position:center">Your current email is
            <span class="text-transparent bg-clip-text bg-gradient-to-r to-blue-500 from-cyan-500"><?= $_SESSION['email'] ?></span>

        </h1>

        <hr class="h-px my-8 bg-gray-200 border-0 dark:bg-gray-700">

        <form action="email2.php" method="post" class="max-w-sm mx-auto">
            <div>
                <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email</label>
                <input type="email" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@company.com" required="">
            </div>
            <div>
                <label for="email2" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Confirm Email</label>
                <input type="email" name="email2" id="email2" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@company.com" required="">
            </div>
            ...
            <div class="flex items-start mb-5">
                ...
                <label for="terms" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">I confirm that i want to change my email</label>
            </div>
