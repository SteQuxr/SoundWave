...
<head>
    ...
    <title> SoundWave - Change Nickname</title>
...
<body class="bg-gray-50 dark:bg-gray-900">
    ...
    <section class="p-8 text-center">
        ...
        <h1 class="text-5xl  font-extrabold dark:text-white position:center">Change
            <span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Nickname</span>
        </h1>

        <hr class="h-px my-8 bg-gray-200 border-0 dark:bg-gray-700">

        <h1 class="text-2xl  font-extrabold dark:text-white position:center">Your current nickname is
            <span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400"><?= $_SESSION['username'] ?></span>

        </h1>

        <hr class="h-px my-8 bg-gray-200 border-0 dark:bg-gray-700">

        <form action="nickname2.php" method="post" class="max-w-sm mx-auto">
            <div>
                <label for="username" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nickname</label>
                <input type="username" name="username" id="username" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="soundwave user" required="">
            </div>
            <div>
                <label for="username2" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Confirm Nickname</label>
                <input type="username" name="username2" id="username2" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="soundwave user" required="">
            </div>
            ...
            <div class="flex items-start mb-5">
                ...
                <label for="terms" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">I confirm that i want to change my nickname</label>
            </div>
