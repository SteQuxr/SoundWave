...
$stmt = $db->query('SELECT
    ...
    songs.genre_id,
    songs.sub_genre_id,
    main_genre.name AS genre_name,
    sub_genre.name AS sub_genre_name
FROM songs
JOIN users ON songs.artist_id = users.id
JOIN genres AS main_genre ON songs.genre_id = main_genre.id
JOIN genres AS sub_genre ON songs.sub_genre_id = sub_genre.id;
');
                ...
                <tbody>
                    <?php foreach ($data as $song): ?>
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                            ...
                            <td class="px-6 py-4">
                                <?php if ($song['picture_path'] == "images/default_song.png"): ?>
                                    default cover art
                                <?php else: ?>
                                    <img class="w-16 h-16" src="../<?= $song['picture_path'] ?>" alt="pfp failed to load">
                                <?php endif; ?>
                            </td>
                            <td class="px-6 py-4">
                                <?= $title = $song['title'] ?>
                            ...
                            <td class="px-6 py-4">
                                <?= $genre_id = $song['genre_id'], " - ", $genres_genre_name = $song['genre_name'] ?>
                            </td>
                            <td class="px-6 py-4">
                                <?= $sub_genre_id = $song['sub_genre_id'], " - ", $genres_sub_genre_name = $song['sub_genre_name'] ?>
                            </td>
                            <td class="px-6 py-4">
                                                ...
                                                <form action="updateSong.php" method="POST">
                                                    ...
                                                    <div class="grid gap-4 mb-4 sm:grid-cols-">
                                                        <div>
                                                            ...
                                                            <input type="text" name="title" id="title" value="<?= $title; ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required="">
                                                        </div>
                                                    </div>
                                                    <div class="grid gap-4 mb-4 sm:grid-cols-">
                                                        <div>
                                                            <label for="duration" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Duration</label>
                                                            <input type="text" name="duration" id="duration" value="<?= $duration; ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required="">
                                                        </div>
                                                    </div>
                                                    <div class="grid gap-4 mb-4 sm:grid-cols-">
                                                        <div>
                                                            <label for="artist_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Artist ID</label>
                                                    ...
                                                    <div class="grid gap-4 mb-4 sm:grid-cols-">
                                                        <div>
                                                            <label for="file_path" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">File Path</label>
                                                            <input type="text" name="file_path" id="file_path" value="<?= $file_path; ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required="">
                                                        </div>
                                                    </div>
                                                    <div class="grid gap-4 mb-4 sm:grid-cols-">
                                                        <div>
                                                            <label for="date_added" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Date Added</label>
                                                            <input datepicker datepicker-format="yyyy-mm-dd" type="date" id="date_added" name="date_added" value="<?= $date_added; ?>"
