...
$stmt = $db->query('SELECT 
    ...
    songs.id AS song_id
FROM songs_comments
INNER JOIN users ON songs_comments.user_id = users.id
                                    ...
                                    <div id="updateProductModal<?= $id ?>" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
                                        <div class="relative p-4 w-full max-w-4xl h-full md:h-auto">
                                            ...
                                            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                                ...
                                                <!-- Modal body -->
                                                <form action="updateSongComment.php" method="POST">
                                                    <input type="hidden" name="id" value="<?= $id; ?>">
                                                    <div class="grid gap-4 mb-4 sm:grid-cols- col-span-2">
                                                        <div>
                                                            <label for="comment_text" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Comment text</label>
                                                            <textarea id="comment_text" name="comment_text" rows="4" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"><?= $text; ?></textarea>
                                                        </div>
                                                    </div>
                                                ...
                                                <form action="deleteSongComment.php" method="POST">
                                                    <input type="hidden" name="id" value="<?= $id; ?>">
